    ...
    <>
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              <div className="relative">
                ...
                <span className="text-purple-600 dark:text-purple-500 group-hover:animate-pulse">.</span>
              </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          <div className="absolute inset-0 bg-black/30 dark:bg-black/50 backdrop-blur-sm" onClick={toggleMenu}></div>
        </div>
      )}

      {/* Mobile Menu */}
      <div className={`fixed top-16 left-0 right-0 z-50 lg:hidden transform transition-all duration-500 ease-out ${
        isOpen ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'
      }`}>
        <div className="bg-white/90 dark:bg-white/10 backdrop-blur-md border border-gray-200/50 dark:border-white/20 mx-4 mt-4 rounded-2xl shadow-xl overflow-hidden">
